...
module.exports = {
  ...
  title: "ZHE知识库",
  description: '基于VuePress的知识库',
  // base: '/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  head: [ // 注入到页面<head> 中的标签，格式[tagName, { attrName: attrValue }, innerHTML?]
    ['link', { rel: 'icon', href: '/./img/favicon.ico' }], //favicons，资源放在public文件夹
    ['meta', { name: 'keywords', content: 'vuepress,theme,blog,vdoing,zhanghanzhe,zhang,hanzhe,zhe,张涵哲,知识库' }],
  ...
  themeConfig: {
    ...
    repo: 'z-hanzhe/docs', // 导航栏右侧生成Github链接
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, href: String}
      name: '张涵哲', // 必需
      href: 'https://www.hanzhe.site' // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:zhang_hanzhe@yeah.net'
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/z-hanzhe'
        }
      ]
    },
    footer: { // 页脚信息
      createYear: 2023, // 博客创建年份
      copyrightInfo: 'Zhe | MIT License', // 博客版权信息，支持a标签
    },
    htmlModules,
  },
  ...
  plugins: [
    ...
    ['one-click-copy', { // 代码块复制按钮
      ...
      copyMessage: '复制成功啦~~~', // default is 'Copy successfully and then paste it for use.'
